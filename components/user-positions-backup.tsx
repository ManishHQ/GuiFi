        ...
        <CardContent className="relative p-8 text-center">
          <div className="mb-4">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm mb-4">
              You don&apos;t have any vault positions or token holdings yet. Make your first
              investment to start earning!
            </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">
                  ...
                  {mockPositions.length + tokenPositions.length !== 1 ? "s" : ""}
                </p>
              </div>
            </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500 dark:text-slate-400">
                        {position.blockchain} • {position.sharesFormatted} shares
                      </p>
          ...
          {tokenPositions.length === 0 ? (
            <Card className="relative overflow-hidden">
              <CardContent className="p-8 text-center">
                ...
                <h4 className="text-lg font-semibold mb-2">No Token Holdings</h4>
                <p className="text-slate-500 dark:text-slate-400 text-sm mb-4">
                  You don&apos;t own any launchpad tokens yet. Participate in token launches to start building your token portfolio.
                </p>
